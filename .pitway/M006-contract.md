...
acceptance_criteria:
  ...
  - id: AC002
    text: Presentation deployed and accessible at http://192.168.100.101/presentation.html
  - id: AC003
...
verification:
  ...
  - id: CT002
    criterion: AC002
    type: command
    command: "curl -s -o /dev/null -w '%{http_code}' http://192.168.100.101/presentation.html | grep -q 200"
  - id: CT003
    criterion: AC003
    type: command
