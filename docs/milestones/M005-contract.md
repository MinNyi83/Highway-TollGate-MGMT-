...
acceptance_criteria:
  ...
  - id: AC003
    text: Vehicle + RFID flow test (create vehicle, bind RFID, simulate passage, verify event).
  - id: AC004
    text: Toll event + transaction flow test (entry, exit, auto-deduction, verify balance).
  - id: AC005
